...
with torch.no_grad():
    ...
    input_prompt = 'f and g are happy couple on the beach'
    ...
    image = pipe(prompt_embeds=encoder_hidden_states, num_inference_steps=50, guidance_scale=guidance_scale,generator=generator,num_images_per_prompt=n_samples).images#[0]
